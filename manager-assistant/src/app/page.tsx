...
function HomePageInner() {
  ...
  function handleTabChange(tab: Tab) {
    ...
    if (tab === "Workflows") setView("primed");
  }

  function handleSubItemChange(code: string) {
    setActiveSubItem(code as SubItem);
    if (activeTab === "Workflows" && code === "AC") setView("primed");
  }
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  />
                  <button
                    className="w-8 h-8 rounded-[10px] shrink-0 text-white text-[14px] flex items-center justify-center cursor-pointer"
                    style={{ background: "#247BA0" }}
                  >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 text-[9px] text-[#6b7280] hover:text-[#247BA0] transition-colors cursor-pointer"
              >
